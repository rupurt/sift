...
updated_at: 2026-03-08T14:00:18
...
- [ ] [SRS-03/AC-01] Benchmark output records the exact command, git SHA, hardware summary, corpus counts, and measured timing or metric fields needed for reproducible evidence capture. <!-- verify: sh -lc 'cargo test bench:: && cargo run -- bench latency --engine bm25 --corpus .cache/eval/scifact-files --queries .cache/eval/scifact-files/test-queries.tsv', SRS-03:start:end, proof: ac-3.log -->
