...
updated_at: 2026-03-10T21:46:47
...
- [x] [SRS-05/AC-05] The release cut remains limited to version-preparation artifacts and does not add unrelated product changes. <!-- verify: sh -lc 'cd "$(git rev-parse --show-toplevel)" && git diff --name-only --cached | rg "^(Cargo.toml|Cargo.lock|RELEASE.md|examples/sift-embed/Cargo.toml|examples/sift-embed/Cargo.lock|\\.keel/)"', SRS-05:start:end, proof: ac-5.log-->
