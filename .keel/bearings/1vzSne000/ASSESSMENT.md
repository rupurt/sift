...
- **Keep Rerank-Only:** Continue with the existing architecture. Rejected because it fails to recover semantically relevant documents that don't appear in the lexical shortlist.
...
- [x] Proceed → convert to epic [SRC-01] [SRC-01] [SRC-01] [SRC-05]
- [ ] Park → revisit later
