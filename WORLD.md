...
- **The API is a Reactor Control Panel:** Developers should be configuring fields and ports, not just calling "search."
- **Evals are Gauges:** We don't just measure "proximity" (MRR); we measure "Reactor Yield" (Signal Gain) and "Protocol Integrity" (Emission Fidelity).
