...
pub use domain::{
    ...
    SearchControllerResponse, SearchControllerState, SearchCoverageActiveRebuild,
    SearchCoverageMode, SearchCoverageSnapshot, SearchEmission, SearchEmissionMode, SearchHit,
